...
public class MyCalendarActivity extends Activity {
	...
	public void onClick(View view) {
		...
		intent.putExtra(Events.TITLE, "Poop");
		intent.putExtra(Events.EVENT_LOCATION, "Home Toilet");
		intent.putExtra(Events.DESCRIPTION, "Downloading yesterday's meal");

		// Setting dates
		GregorianCalendar calDate = new GregorianCalendar(2015, 04, 19);
